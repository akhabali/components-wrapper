...
@PartitionMapper(name = "Input1")
@Documentation("TODO fill the documentation for this mapper")
public class InputMapper1 implements Serializable {
    ...
    public InputMapper1(@Option("configuration") final Configuration1 configuration,
    ...
    @Split
    public List<InputMapper1> split(@PartitionSize final long bundles) {
