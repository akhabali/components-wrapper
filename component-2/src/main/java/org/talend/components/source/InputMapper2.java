...
@PartitionMapper(name = "Input2")
@Documentation("TODO fill the documentation for this mapper")
public class InputMapper2 implements Serializable {
    ...
    public InputMapper2(@Option("configuration") final Configuration2 configuration,
    ...
    @Split
    public List<InputMapper2> split(@PartitionSize final long bundles) {
